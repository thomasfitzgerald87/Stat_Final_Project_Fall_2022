...
## Beginning of Logistic Regression section
...
# Start of Bayesian approach

```{r}
#must be numeric in nimble code
...
constants <- list(n = n, x1 = x1,x2 = x2,x3=x3,x4=x4,x5=x5,x6=x6,x7=x7,x8=x8,x9=x9)
data <- list(y = y)
...
The Bayesian approach has identical performance and predictions as regular logistic regression.
